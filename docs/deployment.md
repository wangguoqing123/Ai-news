...
select indexname from pg_indexes where indexname in ('jobs_blocked_retry_idx','jobs_running_heartbeat_idx','creator_content_analyses_version_idx','event_analyses_version_idx','transcripts_workspace_content_input_uidx');
